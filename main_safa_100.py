...
def main():
    ...
    # Save results to CSV
    os.makedirs("safa_results100", exist_ok=True)
    ...
    accuracy_df.to_csv("safa_results100/accuracy_results.csv", index=False)
    ...
    energy_df.to_csv("safa_results100/energy_per_round.csv", index=False)
    ...
    cumulative_df.to_csv("safa_results100/cumulative_energy_per_client.csv", index=False)
    ...
    selection_df.to_csv("safa_results100/selection_counts.csv", index=False)
    
    # 5. Summary report
    with open("safa_results100/summary_report.txt", "w") as f:
    ...
    plt.tight_layout()
    plt.savefig("safa_results100/aggregated_results.png")
