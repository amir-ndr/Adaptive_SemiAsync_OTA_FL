...
def main():
    ...
    os.makedirs("results_alpha02_random", exist_ok=True)
    
    # Save individual run results
    with open("results_alpha02_random/individual_runs.csv", "w", newline='') as f:
        writer = csv.writer(f)
    ...
    with open("results_alpha02_random/averaged_results.csv", "w", newline='') as f:
        writer = csv.writer(f)
    ...
    plt.savefig("results_alpha02_random/averaged_results.png", dpi=300)
    plt.close()
